...
public class ScriptController {
    ...
    @PostMapping
    public ResponseEntity<ScriptDTO> createScript(@AuthenticationPrincipal CustomUserDetails userDetails, @Valid @RequestBody ScriptRequest scriptRequest) throws IOException {
    ...
    @GetMapping("/execute")
    public ResponseEntity<String> executeRawScript(@AuthenticationPrincipal CustomUserDetails userDetails, @RequestBody ScriptRequest monScriptEnStr) {
